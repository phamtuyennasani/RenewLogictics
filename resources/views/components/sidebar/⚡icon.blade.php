...
<div>
    @switch($this->type)
        ...
        @case('receipt')
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 14.25h6m-6 3h6M5.25 3.75h13.5v16.5l-2.25-1.5-2.25 1.5-2.25-1.5-2.25 1.5-2.25-1.5-2.25 1.5V3.75zM8.25 7.5h7.5m-7.5 3h7.5" />
            </svg>
            @break
        @case('stats')
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
