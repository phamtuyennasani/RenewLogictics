                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 24px; color: #4b5563; font-size: 15px;">
                                Cảm ơn Quý khách đã sử dụng dịch vụ của chúng tôi. Chúng tôi xin gửi đến Quý khách hóa đơn điện tử cho đợt thanh toán vừa qua.
                            </p>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td style="padding: 12px 0; border-bottom: 1px solid #e2e8f0;">
                                                    <span style="color: #6b7280; font-size: 13px;">Mã công nợ</span>
                            ...
                            @if(count($orderCodes) > 0)
                                <p style="margin: 0 0 8px; color: #6b7280; font-size: 13px;">Các mã vận đơn trong công nợ:</p>
                                <p style="margin: 0 0 24px; color: #1f2937; font-size: 14px; background-color: #f1f5f9; padding: 12px 16px; border-radius: 6px; word-break: break-word;">
                                    {{ implode(', ', $orderCodes) }}
                                </p>
                            @endif
